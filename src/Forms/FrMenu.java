...
public class FrMenu extends javax.swing.JFrame {
    ...
    private void aksiLogin(){
        if(txtIDUser.getText().equals("") || txtPassword.getText().equals("")){
            ...
            try{
                ...
                if(res.first()){
                    vlev_user = res.getString("lev_user"); //memberikan nilai pada vlev_user dari hasil query select kolom lev_user
    ...
    private void initComponents() {
        ...
        setTitle("Siakad v.1.0-161530010");

        panelMenu.setBackground(new java.awt.Color(0, 153, 153));
        panelMenu.setForeground(new java.awt.Color(0, 204, 51));
        ...
        jLabel1.setFont(new java.awt.Font("Chaparral Pro", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 51, 153));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Login Siakad v.1.0");

        jLabel2.setFont(new java.awt.Font("Swis721 Blk BT", 2, 11)); // NOI18N
        ...
        panelMenuLayout.setHorizontalGroup(
            ...
            .addGroup(panelMenuLayout.createSequentialGroup()
                ...
                .addGroup(panelMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 741, Short.MAX_VALUE)
        ...
        mnLaporanMahasiswa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/report-small2.png"))); // NOI18N
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException,
        ...
        try{
            com.jtattoo.plaf.aero.AeroLookAndFeel.setTheme("Default", "Java Swing", "");
